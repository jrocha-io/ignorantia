---
name: ignorantia
description: Phase 1 da arquitetura bifásica v3.0.0. Roda em chat (Claude Desktop). Conduz entrevista de escopo, gera protocolo pré-registrado, executa busca metadado em bases OA, deduplica, faz screening de título/abstract em 3 passes. Emite `handoff-v1.0.0.json` validado contra `schemas/handoff-v1.schema.json` para Phase 2 (Anthropic Cowork) fazer retrieval + extração + manuscrito + gates + ZIP. USE quando o usuário disser "ignorantia", pedir scoping/rapid/mapping/integrative/realist review, ou iniciar SLR. Phase 2 (Cowork) consome o handoff produzido aqui para gerar o manuscrito final.
---

# ignorantia (chat — Phase 1)
